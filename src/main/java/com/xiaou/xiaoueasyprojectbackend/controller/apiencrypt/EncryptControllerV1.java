package com.xiaou.xiaoueasyprojectbackend.controller.apiencrypt;


import com.xiaou.xiaoueasyprojectbackend.common.domain.model.dto.ResponseDTO;
import com.xiaou.xiaoueasyprojectbackend.common.domain.model.dto.ValidateList;
import com.xiaou.xiaoueasyprojectbackend.common.support.apiencrypt.annotation.ApiDecrypt;
import com.xiaou.xiaoueasyprojectbackend.common.support.apiencrypt.annotation.ApiEncrypt;
 ...
 * 这里用到了注解的方式 如果需要使用可以直接apiencrypt下的所有文件{@link com.xiaou.xiaoueasyprojectbackend.common.support.apiencrypt.annotation.ApiDecrypt}
 * 这里的JweForm就是加密的内容可以按照自己需求去更改
 * 当前加密算法为：SM2 也可以通过修改这个类来更换{@link com.xiaou.xiaoueasyprojectbackend.common.support.apiencrypt.service.ApiEncryptService}
 */
@RestController
